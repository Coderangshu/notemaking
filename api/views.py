...
def getRoutes(request):
    routes = [
        ...
        {'Endpoint': '/notes/<id>/', 'method': 'GET', 'description': 'Returns a single note if user has access'},
        {'Endpoint': '/notes/<id>/', 'method': 'PUT', 'description': 'Updates a note if the user is the owner'},
        {'Endpoint': '/notes/<id>/', 'method': 'DELETE', 'description': 'Deletes a note if the user is the owner'},
        {'Endpoint': '/notes/<id>/share/', 'method': 'POST', 'description': 'Shares a note with a user'},
