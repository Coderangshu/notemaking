...
const Footer = () => {
  ...
  return (
    <div className="sticky z-50 bottom-0 bg-gray-50 dark:bg-gray-900 transition-colors duration-1000 py-4 flex justify-center items-center  font-normal dark:text-white">
